...
install_packages "Compatibilità" wine winbind winetricks xorriso libssl-dev ocl-icd-opencl-dev fakeroot xz-utils unzip libaio1 libncurses5 libnss3-tools
